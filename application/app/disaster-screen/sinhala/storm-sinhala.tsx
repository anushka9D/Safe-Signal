...
export default function StormSinhala() {
            ...
            <View className="flex-1 justify-center">
                <View className="flex-1 flex-row flex-wrap justify-between p-4">
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => router.push('/articles/sinhala/storm-article-1-sinhala')}
                    >
                        <Text className="text-white text-lg font-semibold text-center">
                            විස්තර පත්‍රිකා 01
                        </Text>
                    ...
                    <TouchableOpacity
                        className="bg-gray-800 rounded-xl py-5 px-6 shadow-lg m-1 w-[100%] h-[10%] justify-center"
                        onPress={() => router.push('/articles/sinhala/storm-article-2-sinhala')}
                    >
                        <Text className="text-white text-lg font-semibold text-center">
                            විස්තර පත්‍රිකා 02
                        </Text>
                    ...
                    <TouchableOpacity
                        className="bg-gray-800 rounded-xl py-5 px-6 shadow-lg m-1 w-[100%] h-[10%] justify-center"
                        onPress={() => router.push('/articles/sinhala/storm-article-3-sinhala')}
                    >
                        <Text className="text-white text-lg font-semibold text-center">
                            විස්තර පත්‍රිකා 03
                        </Text>
                    ...
                    <TouchableOpacity
                        className="bg-gray-800 rounded-xl py-5 px-6 shadow-lg m-1 w-[100%] h-[20%] justify-center"
                        onPress={() => router.push('/contacts/sinhala/storm-contacts-sinhala')}
                    >
                        <Text className="text-white text-lg font-semibold text-center">
                            සම්බන්ධතා අංක
                        </Text>
