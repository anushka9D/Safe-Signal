...
export default function Landslide() {
    ...
    const articles = [
        {
            title: "The Science of Landslides Understanding Tectonic Plates and Faults",
            author: "Shivani Vora",
            date: "July 05, 2021",
            image: require('../../assets/images/disasters/land-slide-damage-2.jpg')
        },
        {
            title: "The Science of Landslides Understanding Tectonic Plates and Faults",
            author: "Shivani Vora",
            date: "July 05, 2021",
            image: require('../../assets/images/disasters/land-slide-damage-3.jpg')
        },
        {
            title: "The Science of Landslides Understanding Tectonic Plates and Faults",
            author: "Shivani Vora",
            date: "July 05, 2021",
            image: require('../../assets/images/disasters/land-slide-damage-4.jpg')
        }
    ];
        ...
        <SafeAreaView className="flex-1 bg-white">
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                ...
                <View className="relative h-48">
                    <Image
                        source={require('../../assets/images/disasters/land-slide-damage-1.jpg')}
